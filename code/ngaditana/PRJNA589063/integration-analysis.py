...
if __name__ == '__main__':
    ...
    # fastcore(model)
    # tinit()
    sampling_analysis(model, join(RESULTS_PATH, "dfa/C5_fastcore_N5_fastcore_results.csv"), "BOIMMG (PC)")
